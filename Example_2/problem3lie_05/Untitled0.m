...
y_r=exp(-x).*sin(x);   %Exact solution y_1 in the training set
yy_r=exp(-x).*cos(x)-exp(-x).*sin(x); %Exact solution y_2 in the training set
y_test_r=exp(-q).*sin(q);   %Exact solution y_1 in the test set
yy_test_r=exp(-q).*cos(q)-exp(-q).*sin(q); %Exact solution y_2 in the test set

y_a_r=exp(-B).*sin(B);   %Exact solution y_1 for random points in the training set
yy_a_r=exp(-B).*cos(B)-exp(-B).*sin(B);  %Exact solution y_2 for random points in the training set
...
derivation1=(sum(abs(y-y_r)))./m;  % Average of the deviation of the network solution y_1 and the exact solution y_1at each point in the training set
...
derivation3=(sum(abs(y_test-y_test_r)))./mm;   % Average of the deviation of the network solution y_1 and the exact solution y_1at each point in the test set
